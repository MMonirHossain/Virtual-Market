...
if(isset($_REQUEST['imagesubmit']))
                    ...
                    try{
                        ...
                        if(empty($_FILES['pimg']['name'])){throw new Exception('Select image');}

                        $filesize=filesize($_FILES['pimg']['tmp_name'])*.0009765625*.0009765625;
                        ...
                        $target="products/".basename($_FILES['pimg']['name']);
            ...
            <div class="main">
                <div class="addproduct">
                        ...
                        <form action="addproduct.php" id="addproduct" method="post" enctype="multipart/form-data">
                            ...
                            <input type="text" class="box" name="pname" id="name" placeholder="Enter product name here">
                            <br><br>
                            <label for=""class="addp">Price</label><br>

                            <input type="text" class="box" name="pprice" id="name" placeholder="Enter product price here">
                            <br><br>
                            <label for=""class="addp">Description</label><br>

                            <textarea type="text" name="pdes" id="name" maxlength="200" > </textarea>
                            <br><br>
                            ...
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="submit" class="box" id="submit" name="imagesubmit" value="ADD" >
                        </form>
                </div>
            </div>
